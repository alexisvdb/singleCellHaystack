...
Our manuscript about `singleCellHaystack` has been published in Nature Communications ([link](https://doi.org/10.1038/s41467-020-17900-3)).
...
You can also install the `singleCellHaystack` from the GitHub repository as shown below. Typical installation times should be less than 1 minute.
