...
vignette: >
  %\VignetteIndexEntry{Introduction to haystack}
...
You can install the development version of singleCellHaystack from github with:

``` r
remotes::install_github("alexisvb/single-cell-haystack")
```
